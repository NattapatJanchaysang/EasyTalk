...
const Navbar = () => {
  const {user} = useUser()
  return (
    <nav className="flex w-full items-center justify-between border-t border-b border-neutral-200 py-4 dark:border-neutral-800 px-10 md:px-24 lg:px-40 fixed">
      <Link href='/' className="cursor-pointer"><ColourfulText text="EasyTalk"/></Link>
